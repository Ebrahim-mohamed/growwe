  ...
  return (
    <div className="bg-[url('/products/hero.webp')] bg-cover w-dvw h-dvh p-[var(--section-Padding)]  flex items-end justify-start">
      <div className={`font-[ClassicoURW] `}>
        ...
        {/* <div className="flex items-center justify-center gap-[1rem] font-medium text-[4rem] text-white max-[1200px]:text-[3rem] max-[450px]:text-[2.5rem] max-[400px]:text-[2rem]">
          <p>{t("premium")}</p>
          <div className="w-[1rem] h-[1rem] rounded-full bg-white -mb-[1rem]"></div>
          <p>{t("efficient")}</p>
          <div className="w-[1rem] h-[1rem] rounded-full bg-white -mb-[1rem]"></div>
          <p>{t("cost")}</p>
        </div> */}
