...
export function MulchFeatures() {
  ...
  return (
    <div className="p-[var(--section-Padding)] bg-[url('/home/mulchBen.webp')] w-full flex items-center justify-center max-[550px]:flex-col bg-no-repeat bg-cover bg-center min-h-[60rem]">
      <div className="flex items-center justify-center w-full">
        <div className="max-w-[25rem] text-[#FFFDFD] text-[4rem] font-black max-[550px]:max-w-full">
          {t("features")}
        </div>
      </div>
      <div className="flex flex-col items-start justify-center gap-[2rem] w-full relative bg-[rgba(16,16,16,0.4)] rounded-[1rem] p-[2rem]">
