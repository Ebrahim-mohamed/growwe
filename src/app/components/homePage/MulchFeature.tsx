...
export function MulchFeatures() {
  ...
  return (
    <div className="p-[var(--section-Padding)] bg-[url('/home/mulchBen.jpg')] w-full flex items-center justify-center max-[550px]:flex-col bg-no-repeat bg-cover bg-center min-h-[60rem]">
